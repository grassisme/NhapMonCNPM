...
public class LichSuPhieu {
    ...
    public LichSuPhieu(int id, String maPhieu, LocalDate ngay,
                       String loai, String nguoiLap,
                       int soDong, BigDecimal tongTien) {
        this.id = id;
    ...
    public void setSoDong(int soDong) { this.soDong = soDong; }
